...
\newcommand{\myTitle}{Feature Performance Analysis: Differences Between Black-Box and White-Box Models in Configurable Systems\xspace}
\newcommand{\mySubtitle}{\xspace}
\newcommand{\myName}{Manuel Messerig\xspace}
\newcommand{\myProf}{Prof. Dr. Sven Apel\xspace}
\newcommand{\myProfDepartment}{Chair of Software Engineering}
\newcommand{\myOtherProf}{Prof. Dr. Jan Reineke \xspace}
\newcommand{\myOtherProfDepartment}{Real-Time and Embedded Systems Lab}
\newcommand{\myAdvisor}{Florian Sattler\xspace}
\newcommand{\myOtherAdvisor}{Christian Kaltenecker\xspace}
...
\newcommand{\autorefLine}[1]{\hyperref[#1]{Line~\ref*{#1}}}
\newcommand{\refAlgorithm}[1]{\hyperref[#1]{Algorithm~\ref*{#1}}}
\newcommand{\perfInfluenceModel}{{performance-influcence model}}
